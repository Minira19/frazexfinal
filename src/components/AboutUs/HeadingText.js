  ...
  return (
    <Container maxWidth="xl">
      <Grid style={{width:'95%',margin:'auto'}} container direction="column">
       ...
       Our specificity is not to scatter beautiful words about promoting an
      idea, but to really comprehend it- how it lives, how it works,
      what difficulties it faces every day.
                      </Typography>             
          </Grid>           
        </Grid>
      </Grid>
